...
This page aims to provide a quick guide to the different options that are out there, as well as help you get up and running with your MiniDisc-on-Mac method of choice.
...
Platinum-MD is a local application rather than a webapp, but otherwise offers a similar experience and feature-set to Web MiniDisc. It's a bit more complicated to set-up, requiring manual installation of some necessary components through the terminal, but once everything's rolled up it offers an intuitive graphical interface for easily moving music to your NetMD player.

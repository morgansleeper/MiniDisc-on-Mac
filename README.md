...
This gist aims to provide a quick guide to the different options that are out there, as well as help you get up and running with your MiniDisc-on-Mac method of choice.
